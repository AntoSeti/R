...
for(i in 4:4){
  # Baby 3 month
plot(envelope(X_baby3month_Im[[i]],Kest,r=rr,nsim=100,nrank=trunc(.025*100)),main=paste("K, 3 mois, Rafting")) 
  # Baby 6 month
plot(envelope(X_baby6month_Im[[i]],Kest,r=rr,nsim=100,nrank=trunc(.025*100)),main=paste("K, 6 mois, Rafting"))

  # Baby 9 month
plot(envelope(X_baby9month_Im[[i]],Kest,r=rr,nsim=100,nrank=trunc(.025*100)),main=paste("K, 9 mois, Rafting"))

  # Baby 12 month
 plot(envelope(X_baby12month_Im[[i]],Kest,r=rr,nsim=100,nrank=trunc(.025*100)),main=paste("K, 12 mois, Rafting"))

  # Adulte
plot(envelope(X_adult_Im[[i]],Kest,r=rr,nsim=100,nrank=trunc(.025*100)),main=paste("K, adultes, Rafting"))
}
...
for(i in 1:6){
  lambda=density(X_Im[[i]], bw.ppl)
  plot(envelope(X_Im[[i]], Kinhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Kinhom, Image",i))
}
...
for(i in 6:6){
  # Baby 3 month
  par(mfrow=c(2,2))
  lambda=density(X_baby3month_Im[[i]],bw.ppl)
  plot(envelope(X_baby3month_Im[[i]], Kinhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Kinhom, bb3m, Image",i))
  plot(envelope(X_baby3month_Im[[i]], Linhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Linhom, bb3m, Image",i))
  plot(envelope(X_baby3month_Im[[i]], Finhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Finhom, bb3m, Image",i))
  plot(envelope(X_baby3month_Im[[i]], Ginhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Ginhom, bb3m, Image",i))
  
  # Baby 6 month
  par(mfrow=c(2,2))
  lambda=density(X_baby6month_Im[[i]],bw.ppl)
  plot(envelope(X_baby6month_Im[[i]], Kinhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Kinhom, bb6m, Image",i))
  plot(envelope(X_baby6month_Im[[i]], Linhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Linhom, bb6m, Image",i))
  plot(envelope(X_baby6month_Im[[i]], Finhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Finhom, bb6m, Image",i))
  plot(envelope(X_baby6month_Im[[i]], Ginhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Ginhom, bb6m, Image",i))

  # Baby 9 month
  par(mfrow=c(2,2))
  lambda=density(X_baby9month_Im[[i]],bw.ppl)
  plot(envelope(X_baby9month_Im[[i]], Kinhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Kinhom, bb9m, Image",i))
  plot(envelope(X_baby9month_Im[[i]], Linhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Linhom, bb9m, Image",i))
  plot(envelope(X_baby9month_Im[[i]], Finhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Finhom, bb9m, Image",i))
  plot(envelope(X_baby9month_Im[[i]], Ginhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Ginhom, bb9m, Image",i))
  
  # Baby 12 month
  par(mfrow=c(2,2))
  lambda=density(X_baby12month_Im[[i]],bw.ppl)
  plot(envelope(X_baby12month_Im[[i]], Kinhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Kinhom, bb12m, Image",i))
  plot(envelope(X_baby12month_Im[[i]], Linhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Linhom, bb12m, Image",i))
  plot(envelope(X_baby12month_Im[[i]], Finhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Finhom, bb12m, Image",i))
  plot(envelope(X_baby12month_Im[[i]], Ginhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Ginhom, bb12m, Image",i))
  
  # Adulte
  par(mfrow=c(2,2))
  lambda=density(X_adult_Im[[i]],bw.ppl)
  plot(envelope(X_adult_Im[[i]], Kinhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Kinhom, adultes, Image",i))
  plot(envelope(X_adult_Im[[i]], Linhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Linhom, adultes, Image",i))
  plot(envelope(X_adult_Im[[i]], Finhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Finhom, adultes, Image",i))
  plot(envelope(X_adult_Im[[i]], Ginhom, sigma=bw.ppl, simulate=expression(rpoispp(lambda)), nsim=19, global=TRUE),main=paste("Ginhom, adultes, Image",i))
}
